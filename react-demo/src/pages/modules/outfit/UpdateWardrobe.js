...
const UpdateWardrobeSteward = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('http://121.4.22.55:5201/api/Reactwardrobe/add', submitData);
            ...
            await axios.post('http://121.4.22.55:5201/api/Reactwardrobe/upload-images', formDataImages, {
                headers: {
