...
const socket = io('http://121.4.22.55:5201'); // 与你的后端 socket 地址匹配
...
const FriendManagement = ({ username, refreshFriends }) => {
    ...
    const fetchFriendRequests = async () => {
        try {
            const response = await axios.get('http://121.4.22.55:5201/api/user-management');
    ...
    const fetchUserHeadImage = async () => {
        try {
            const response = await axios.get('http://121.4.22.55:5201/api/getuserheadimage', {
                params: { username }
            });
    ...
    const handleSearch = async () => {
        ...
        setSearchResults([]);
        try {
            const response = await axios.get(`http://121.4.22.55:5201/api/validate-user/${searchQuery}`);
    ...
    const handleAddFriend = async (friend) => {
        try {
            ...
            await axios.post('http://121.4.22.55:5201/api/user-management', {
                username,
                friend,
    ...
    const handleAcceptRequest = async (requestId) => {
        try {
            ...
            if (currentRequest) {
                ...
                await axios.put(`http://121.4.22.55:5201/api/user-management/${username}/${friendName}/accept`);
                await axios.put(`http://121.4.22.55:5201/api/user-management/${friendName}/${username}/accept`);
            }
            fetchFriendRequests();
            fetchCurrentFriends();
            if (refreshFriends) {
    ...
    const handleRejectRequest = async (requestId) => {
        try {
            ...
            if (currentRequest) {
                ...
                const allRequestsResponse = await axios.get('http://121.4.22.55:5201/api/user-management');
                ...
                if (forwardRequest) {
                    await retryDelete(`http://121.4.22.55:5201/api/user-management/${username}/${friendName}`);
                }
                if (reverseRequest) {
                    await retryDelete(`http://121.4.22.55:5201/api/user-management/${friendName}/${username}`);
                }
            }
            fetchFriendRequests();
            fetchCurrentFriends();
    ...
    const handleDeleteFriend = async (friend) => {
        try {
            await axios.delete(`http://121.4.22.55:5201/api/user-management/${username}/${friend}`);
            await axios.delete(`http://121.4.22.55:5201/api/user-management/${friend}/${username}`);
            alert('好友已删除');
            fetchCurrentFriends();
            if (refreshFriends) {
                refreshFriends();
    ...
    const saveNickname = async (friend) => {
        try {
            ...
            await axios.post('http://121.4.22.55:5201/api/update-nickname', {
                username,
                friend,
                newNickname
            });
